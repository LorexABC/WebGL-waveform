...
function draw() {
  ...
  stats.end();
  if (renderLoop) requestAnimationFrame(function () {
    return draw();
  });
}
draw();
document.querySelector(".render-loop input").addEventListener("click", function () {
...
},{"stats.js":"node_modules/stats.js/build/stats.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
